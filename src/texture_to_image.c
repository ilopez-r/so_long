...
/*   Updated: 2024/01/25 12:50:54 by ilopez-r         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (!g->t_coin || !g->t_floor || !g->t_pd || !g->t_pi || !g->t_sa
		|| !g->t_sc || !g->t_wall || !g->i_coin || !g->i_floor || !g->i_pd
		|| !g->i_pi || !g->i_sa || !g->i_sc || !g->i_wall)
		return (EXIT_FAILURE);
	return (EXIT_SUCCESS);
}
