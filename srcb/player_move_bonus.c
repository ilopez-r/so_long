...
/*   Updated: 2024/01/30 11:47:58 by ilopez-r         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	contador(t_game *game)
{
	char	*contador;

	contador = ft_itoa(game->moves);
	mlx_image_to_window(game->mlx, game->i_floor, 0, 0);
	mlx_put_string(game->mlx, contador, 16, 10);
	free(contador);
}
